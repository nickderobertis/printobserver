...
def test_a_recipe_carries_its_dependencies_and_its_body() -> None:
    ...
    assert parsed["check"].dependencies == ("lint",)
    assert parsed["check"].body == ("just test",)
    assert parsed["lint"].body == ("cargo clippy",)
